...
;     Written.
;   Mark Hadfield, 2009-09:
;     After all these years, I've noticed that this routine returns
;     open--rather than closed--polygons (ie, the starting point
;     is not duplicated at the end). This was not my intention so
;     I've added the CLOSED keyword.
;-
function mgh_perim, x, y, CLOSED=closed
